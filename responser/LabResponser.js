...
LabResponser.prototype.getListForTestResponse = function (lab_test_list) {
    var self = this;
    var responseList = [];
    lab_test_list.forEach(function(lab_test){
        ...
        var tests = self.MapObjects(test_ids, test_names, test_prices);
        ...
        response.total_price = lab_test.total_price;
        responseList.push(response);
    })
    return responseList;
    
}
LabResponser.prototype.MapObjects = function(array1, array2, array3){
    var length = 0;
    var tests = [];
